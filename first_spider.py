...
class FirstSpider(feapder.AirSpider):
    ...
    def parse_detail(self, request, response):
        ...
        # print(name_tag)
        test = response.xpath(
            '//*[@id="table-subcatid-0"]/tbody/tr/td/a/text() | //*[@id="table-subcatid-0"]/tbody/tr/td/span/a/text()').getall()
        test3 = response.xpath('//*[@id="table-subcatid-0"]/tbody/tr/td[2]/text()').getall()
        print(test)
        print(test3)
